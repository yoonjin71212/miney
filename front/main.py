...
class Miney_Client(GridLayout):
    def __init__(self, **kwargs):
        ...
        self.spinlock = False
        response = requests.get('http://daegu.yjlee-dev.pe.kr:34000/request').text
        if len(response):
    ...
    def onDeletePress(self,instance):
        ...
        try:
            self.spinlock = True
            r = requests.post('http://daegu.yjlee-dev.pe.kr:34000/delete', data=self.seltagArr[self.sel])
